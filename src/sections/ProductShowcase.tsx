    ...
    <div className="container">
      <div className='section-heading '>
        <div className='flex justify-center'>
          <div className='tag'>Meet your Match</div>
        </div>
        <h2 className='section-title mt-5 '>Find your match | Chat | Video call</h2>
        <p className='section-description mt-5  '>Mingle is geared for singles and people who are interested in meeting singles. Check out these key features:</p>
      </div>
